...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2025 at 01:43 AM
...
(62, 27, 'logout', 'user', 27, 'User logged out', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:01:42'),
(63, 1, 'login', 'user', 1, 'User logged in successfully', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:02:04'),
(64, 1, 'logout', 'user', 1, 'User logged out', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:03:26'),
(65, 27, 'login', 'user', 27, 'User logged in successfully', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:03:35'),
(66, 27, 'logout', 'user', 27, 'User logged out', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:16:20'),
(67, 28, 'login', 'user', 28, 'User logged in successfully', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-08-12 14:17:05');
...
INSERT INTO `departments` (`id`, `department_code`, `department_name`, `description`, `head_of_department`, `contact_email`, `contact_phone`, `created_at`, `updated_at`, `is_active`, `parent_id`) VALUES
(1, 'TED', 'Teacher Education Department', 'Responsible for teacher training and education programs', 'Dr. TED', 'ted@cvsu.edu.ph', '+63-2-1234-5671', '2025-08-07 01:55:15', '2025-08-07 15:26:18', 1, NULL),
(2, 'MD', 'Management Department', 'Business administration and management programs', 'Prof. MD', 'md@cvsu.edu.ph', '+63-2-1234-5672', '2025-08-07 01:55:15', '2025-08-07 15:26:18', 1, NULL),
(3, 'ITD', 'Information Technology Department', 'Computer science and information technology programs', 'Dr. Michelle C. Tanega', 'itd@cvsu.edu.ph', '+63-2-1234-5673', '2025-08-07 01:55:15', '2025-08-07 15:25:30', 1, NULL),
(4, 'FASD', 'Fisheries and Aquatic Science Department', 'Marine biology and fisheries management programs', 'Dr. FASD', 'fasd@cvsu.edu.ph', '+63-2-1234-5674', '2025-08-07 01:55:15', '2025-08-07 15:26:18', 1, NULL),
(5, 'ASD', 'Arts and Science Department', 'Liberal arts and natural sciences programs', 'Prof. ASD', 'asd@cvsu.edu.ph', '+63-2-1234-5675', '2025-08-07 01:55:15', '2025-08-07 15:26:18', 1, NULL),
(6, 'NSTP', 'National Service Training Program', 'Civic education and defense preparedness program for tertiary students', 'Dr. NSTP', 'nstp@cvsu.edu.ph', '+63-2-1234-5676', '2025-08-07 15:27:33', '2025-08-07 15:27:33', 1, NULL),
(7, 'OTHR', 'Others', 'For students or faculty not assigned to a specific academic department', 'Dr. Angelito Decatoria III', NULL, NULL, '2025-08-07 15:27:33', '2025-08-12 13:55:52', 1, NULL);
...
(1, 'superadmin', 'admin@cvsu.edu.ph', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'super_admin', 1, 'System', '', 'Administrator', 'ADMIN001', 'System Administrator', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2025-08-12 14:02:04', 0, NULL, 1, NULL, NULL, NULL, '2025-08-07 01:55:15', '2025-08-12 14:02:04', NULL, NULL, NULL),
(27, 'itdadmin', 'itdadmin@cvsu.edu.ph', '$2y$10$ZM.zHjOD1jFImsnyAJRwCeN2amu/f6YBl6yub49Y71fl0ViHLPtOO', 'admin', 1, 'ITD', '', 'Administrator', 'ITD001', 'Department Administrator', 3, 0, NULL, NULL, NULL, NULL, NULL, '2025-08-12 14:03:35', 0, NULL, 1, NULL, NULL, NULL, '2025-08-07 01:55:15', '2025-08-12 14:03:35', NULL, 1, '2025-08-07 01:55:15'),
(28, 'hbalanza', 'henry.balanza@cvsu.edu.ph', '$2y$10$kRVE4pnSIX6YvPrVGbMrX.x.0P1pnPsGTpr4P65xChwbJe4Mwedey', 'user', 1, 'Henry', 'R', 'Balanza', 'ITD002', 'Assistant Professor', 3, 0, NULL, NULL, NULL, NULL, NULL, '2025-08-12 14:17:05', 0, NULL, 1, NULL, NULL, NULL, '2025-08-07 01:55:15', '2025-08-12 14:17:05', NULL, 27, '2025-08-07 01:55:15'),
(29, 'mtimola', 'luigi.timola@cvsu.edu.ph', '$2y$10$IrcJneb3t//.O370AcJ75.N20qreX2nHkYp3eWnetOLgSHQ62txMq', 'user', 1, 'Marc Luigi', 'G', 'Timola', 'ITD003', 'Associate Professor', 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, 1, NULL, NULL, NULL, '2025-08-07 01:55:15', '2025-08-12 14:16:53', NULL, 27, '2025-08-07 01:55:15'),
(30, 'rriel', 'rj.riel@cvsu.edu.ph', '$2y$10$CTAcrRPYboonzGIiDpw8S.thwJ7ueM0nkVN4XdQo4vNXAmt6aXnYC', 'user', 1, 'Ricky Jay', 'A', 'Riel', 'ITD004', 'Instructor', 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, 1, NULL, NULL, NULL, '2025-08-07 01:55:15', '2025-08-12 14:16:43', NULL, 27, '2025-08-07 01:55:15'),
