-- Social Media Feed Database Schema
-- Add to your existing myd_db database
...
BEGIN
    ...
    AND (
        ...
        (p.visibility = 'department' AND JSON_CONTAINS(p.target_departments, CAST(p_department_id AS JSON))) OR
...
(2, 29, 'I\ll be there. Thanks for the reminder!', DATE_SUB(NOW(), INTERVAL 1 HOUR));
