...
function initializeFormValidation() {
    ...
    if (usernameInput && passwordInput) {
        ...
        // Password validation for login - SIMPLIFIED to only check minimum length
    ...
    function validateCurrentStep(stepNumber) {
        ...
        requiredInputs.forEach(input => {
            ...
            if (!value) {
                ...
                // SIMPLIFIED: Only check minimum length for password
...
/**
 * Initialize improved password strength indicator - KEPT for visual feedback
 */
...
/**
 * Password strength calculation - KEPT for indicator, but doesn't affect validation
 */
...
/**
 * Validate entire form (for login) - SIMPLIFIED password validation
 */
function validateForm() {
    ...
    // Validate password - ONLY check minimum length
...
function validateAllSteps() {
    ...
    wizardSteps.forEach((step, index) => {
        ...
        requiredInputs.forEach(input => {
            ...
            // SIMPLIFIED: Only check minimum length for password
            if (input.id === 'password' && value && value.length < 6) {
                showFieldError(errorElement, 'Password must be at least 6 characters');
                input.classList.add('error');
                isValid = false;
            }
